...
class OrdinaryDrinksAdapter : RecyclerView.Adapter<OrdinaryDrinksAdapter.OrdinaryDrinksViewHolder>()  {
    ...
    inner class OrdinaryDrinksViewHolder(val binding: OrdinaryDrinksBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OrdinaryDrinksViewHolder {
        return OrdinaryDrinksViewHolder(OrdinaryDrinksBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
