...
class FavoriteMealsAdapter : RecyclerView.Adapter<FavoriteMealsAdapter.FavoriteMealsAdapterViewHolder>() {
    inner class FavoriteMealsAdapterViewHolder(val binding : CategoryViewsBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(
        ...
        return FavoriteMealsAdapterViewHolder(CategoryViewsBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
    ...
    override fun onBindViewHolder(holder: FavoriteMealsAdapterViewHolder, position: Int) {
        ...
        holder.binding.tvCategoryMeal.text = meal.strMeal
    }
}